define([
    'Customweb_CollectorCw/js/view/payment/method-renderer/collectorcw_collectorinstallment-method',
    ...
    return Component.extend({
        defaults: {
            template: 'Ambientia_CollectorStrongAuthentication/payment/collectorcw_collectorinstallment',
        },
